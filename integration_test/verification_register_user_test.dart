...
void main() {
  ...
  testWidgets('Test de integración de la pantalla de Registro', (WidgetTester tester) async {
    ...
    expect(find.byType(TextField), findsNWidgets(4)); // Asume que hay cuatro campos de texto (user, email y dos password)
    ...
    await tester.enterText(find.byType(TextField).at(1), 'test12345@example.com');
